...
//	virtual void	SetActivator( CBaseEntity *pActivator ) {}
	...
	Vector		FireBulletsPlayer( ULONG	cShots, Vector  vecSrc, Vector	vecDirShooting,	Vector	vecSpread, float flDistance, int iBulletType, int iTracerFreq = 4, int iDamage = 0, entvars_t *pevAttacker = NULL, int shared_rand = 0, float penetration=0 );
	...
	int m_fInAttack;
    bool m_bIsReady; // hle
    int m_iVote; // -1 = no, 0 = undecided, 1 = yes  ; hle
    bool m_bInitMapList;
...
class CBaseDMStart : public /*CPointEntity*/CBaseEntity
{
