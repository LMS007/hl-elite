...
CBaseEntity* CHealthKit::Drop(CBasePlayer* pPlayer)
{
	CBaseEntity *pEnt;
	CItem *pTemp=NULL;
	...
	pEnt = CBaseEntity::Create( "item_healthkit", pPlayer->pev->origin ,pPlayer->pev->angles, pPlayer->edict() );
	...
	CHealthKit *pHealth = (CHealthKit *)pEnt;
