...
BOOL CHalfLifeRules::CanPlayerSpawn( CBasePlayer* pPlayer )
{
	return TRUE;
}

void CHalfLifeRules::CapturedFlag(CBasePlayer *pPlayer)
{
}

BOOL CHalfLifeRules::RestrictObserver( void )
{
	return FALSE;
}

BOOL CHalfLifeRules::CanStartAutoObserver(CBasePlayer* pPlayer)
{
	return TRUE;
}


void CHalfLifeRules::RemovePlayer(CBasePlayer* pPlayer)
{
	
}

void CHalfLifeRules::ResumePlayer(CBasePlayer* pPlayer)
{
...
edict_t *CHalfLifeRules::GetRandomSpawn( CBasePlayer *pPlayer )
{
	return NULL;
}
void CHalfLifeRules::InitSpawns()
{
}

int CHalfLifeRules::CheckValidTeam(char* pCurrentTeam, char* pNewTeam)
{
	return 0;
}

void CHalfLifeRules::StartObserver(CBasePlayer *pPlayer)
{
}