...
cvar_t	overwrite_nextmap = { "overwrite_nextmap", "0", FCVAR_SERVER | FCVAR_UNLOGGED };
cvar_t	nextmap = { "nextmap", "", FCVAR_SERVER | FCVAR_UNLOGGED };
cvar_t	teamplay	= {"mp_teamplay","0", FCVAR_SERVER | FCVAR_UNLOGGED };
cvar_t	fragsleft	= {"mp_fragsleft","0", FCVAR_SERVER | FCVAR_UNLOGGED };	  // Don't spam console/log files/users with this changing
cvar_t	winsleft	= {"mp_winsleft","0", FCVAR_SERVER | FCVAR_UNLOGGED };
cvar_t	timeleft	= {"mp_timeleft","0" , FCVAR_SERVER | FCVAR_UNLOGGED };	  // "      "

cvar_t  loadedrestart	= { "mp_loadedstart", "0", FCVAR_SERVER | FCVAR_UNLOGGED };
cvar_t  pausegame	= { "pausegame", "0", FCVAR_SERVER | FCVAR_UNLOGGED};
cvar_t  tournament = { "tournament", "0", FCVAR_SERVER | FCVAR_UNLOGGED};
cvar_t  allowvotes = { "mp_allowvotes", "1", FCVAR_SERVER };
//cvar_t  modeconfig = { "mp_modeconfig", "default", FCVAR_SERVER };		// which config file do we load after /mode/default.cfg
//cvar_t  allowop4 = { "mp_allowop4", "1", FCVAR_SERVER };

// vote stuff
cvar_t  votetime	= { "mp_votetime", "25", FCVAR_SERVER};
cvar_t	satchelexplode = { "mp_satchelexplode", "0", FCVAR_SERVER };
cvar_t	radar = { "mp_radar", "1", FCVAR_SERVER };
cvar_t  maxteams = { "mp_maxteams", "6", FCVAR_SERVER };
cvar_t  matchstart = { "mp_matchstart", "1", FCVAR_SERVER };
cvar_t  allowmatchvotes = { "mp_allowmatchvotes", "1", FCVAR_SERVER };
cvar_t  resumetime = { "mp_resumetime", "300", FCVAR_SERVER };




// new stuff
cvar_t	regeneration = { "mp_regeneration", "100", FCVAR_SERVER}; 
cvar_t	corpsequeue = { "mp_corpsequeue", "3", FCVAR_SERVER };
//cvar_t	tossitem = { "mp_tossitem", "0", FCVAR_SERVER };
cvar_t	roundtime = { "mp_roundclock", "0", FCVAR_SERVER };
cvar_t	banmodes = { "mp_banmodes", "", FCVAR_SERVER };
cvar_t	spawnform = { "mp_spawnform", "0", FCVAR_SERVER };
cvar_t	banentities = { "mp_banentities", "", FCVAR_SERVER };
cvar_t  banweapons	= { "mp_banweapons", "", FCVAR_SERVER };
cvar_t  loselongjump =  { "mp_loselongjump", "0", FCVAR_SERVER };
cvar_t  showlongjump =  { "mp_showlongjump", "1", FCVAR_SERVER };


//cvar_t	disablea3dperiod	= { "mp_disablea3dperiod", "5", FCVAR_SERVER };
cvar_t	flaghandicap	= { "mp_flaghandicap", "0.60", FCVAR_SERVER };
//cvar_t	allowa3d	= { "mp_allowa3d", "1", FCVAR_SERVER };



cvar_t  gamemode	= { "mp_gamemode", "", FCVAR_SERVER };
cvar_t	fraglimit	= {"mp_fraglimit","0", FCVAR_SERVER };
cvar_t	spawnlimit	= {"mp_spawnlimit","0", FCVAR_SERVER };
cvar_t	timelimit	= {"mp_timelimit","0", FCVAR_SERVER };
cvar_t  winlimit	= { "mp_winlimit", "0", FCVAR_SERVER };		// 0 prevents players from being spectators
...
cvar_t	lockteams = {"mp_lockteams","0" };
//cvar_t	defaultteam = {"mp_defaultteam","0" };
cvar_t	allowmonsters={"mp_allowmonsters","0", FCVAR_SERVER };
cvar_t	reset={"reset","0", FCVAR_SERVER };
cvar_t	resetloaded={"resetloaded","0", FCVAR_SERVER };
...
//	CVAR_REGISTER(&allowop4);
	CVAR_REGISTER(&allowvotes);
	CVAR_REGISTER (&matchstart);
	CVAR_REGISTER (&allowmatchvotes);
	CVAR_REGISTER (&resumetime);
	CVAR_REGISTER (&showlongjump);
	CVAR_REGISTER (&radar);
	CVAR_REGISTER (&maxteams);
	CVAR_REGISTER (&displaysoundlist);
	CVAR_REGISTER (&satchelexplode);
	CVAR_REGISTER(&regeneration);
	CVAR_REGISTER(&flaghandicap);
	CVAR_REGISTER(&loselongjump);
	CVAR_REGISTER(&corpsequeue);
//	CVAR_REGISTER(&tossitem);
//	CVAR_REGISTER(&allowa3d);
	//CVAR_REGISTER(&disablea3dperiod);

	CVAR_REGISTER(&pausegame);

	CVAR_REGISTER(&votetime);


	CVAR_REGISTER(&banweapons);
	CVAR_REGISTER(&roundtime);
	CVAR_REGISTER(&banmodes);
	CVAR_REGISTER(&spawnform);
	CVAR_REGISTER(&banentities);
	

	CVAR_REGISTER (&overwrite_nextmap);
	CVAR_REGISTER (&nextmap);
	CVAR_REGISTER (&teamplay);
	CVAR_REGISTER (&fraglimit);
	CVAR_REGISTER (&timelimit);
    CVAR_REGISTER (&winlimit);
	CVAR_REGISTER (&spawnlimit);

	CVAR_REGISTER( &loadedrestart );
	CVAR_REGISTER( &reset);
	CVAR_REGISTER( &resetloaded);

    CVAR_REGISTER (&gamemode);
	CVAR_REGISTER (&fragsleft);
	CVAR_REGISTER (&timeleft);
	CVAR_REGISTER (&winsleft);
