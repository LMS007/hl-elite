...
void V_CalcSpectatorRefdef ( struct ref_params_s * pparams )
{
	...
	//	if ( gEngfuncs.IsSpectateOnly() ) hle
		{
...
void V_Init (void)
{
	...
	scr_ofsx			= gEngfuncs.pfnRegisterVariable( "scr_ofsx","0", 0  | FCVAR_SPONLY);
	scr_ofsy			= gEngfuncs.pfnRegisterVariable( "scr_ofsy","0", 0  | FCVAR_SPONLY);
	scr_ofsz			= gEngfuncs.pfnRegisterVariable( "scr_ofsz","0", 0  | FCVAR_SPONLY);
