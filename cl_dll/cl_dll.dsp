...
"client.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy                                                           $(TargetPath)                                                         C:\SIERRA\Half-Life\hle\cl_dlls\  
	copy                                $(TargetPath)                                  C:\Steam\SteamApps\steams~1.com\half-life\hle\cl_dlls\  
...
# ADD CPP /nologo /G5 /MTd /W3 /Gm /GR /GX /ZI /I "..\dlls" /I "..\common" /I "..\pm_shared" /I "..\engine" /I "..\utils\vgui\include" /I "..\game_shared" /D "_DEBUG" /D "_MBCS" /D "WIN32" /D "_WINDOWS" /D "CLIENT_DLL" /D "CLIENT_WEAPONS" /FR /YX /FD /c
...
# Begin Custom Build - Copying client dll into folder
TargetPath=.\Debug\client.dll
InputPath=.\Debug\client.dll
SOURCE="$(InputPath)"

"client.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy           $(TargetPath)             \\Kyle2\hle\cl_dlls\  
	copy           $(TargetPath)             C:\Steam\SteamApps\steams~1.com\half-life\hle\cl_dlls\  
...
SOURCE=..\dlls\hle_flagevents.h
# End Source File
# Begin Source File

SOURCE=..\dlls\hle_maploader.cpp
# End Source File
# Begin Source File

SOURCE=..\dlls\hle_maploader.h
# End Source File
# Begin Source File
...
SOURCE=.\vgui_HelpMenu.cpp
# End Source File
# Begin Source File

SOURCE=.\vgui_HLE_Menu.cpp
# End Source File
# Begin Source File
