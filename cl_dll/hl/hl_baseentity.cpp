...
CBaseEntity* CBasePlayerWeapon::TossWeapon() { return NULL; }
...
void ApplyMultiDamage(entvars_t *pevInflictor, entvars_t *pevAttacker ) { } // hle
...
//void CBasePlayerWeapon::SetNextPrimaryAttackDelay( float delay ) { m_flNextPrimaryAttack = delay; }
//void CBasePlayerWeapon::SetNextSecondaryAttackDelay( float delay ) { m_flNextSecondaryAttack = delay;  }
...
/*void CBasePlayerWeapon::EndFire( void )
{ 
	// HLE time fix
